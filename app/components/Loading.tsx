export const Loading = () =>{
    return(
        <section className="absolute pt-10 w-full flex justify-center">
            <div role="status" >
...
export const WelcomeBlogLoading =()=>{
    return(
        <div className="w-full flex justify-center animate-pulse">
            <div className="w-full md:w-[500px] h-60 pt-4 bg-gray-700">
                <div className="w-[90%] h-20 mx-auto mb-4 bg-gray-900">

                </div>
                <div className="w-[90%] h-4 mx-auto mb-2 bg-gray-900">
                </div>
                <div className="w-[90%] h-4 mx-auto mb-2 bg-gray-900">
                </div>
                <div className="w-[90%] h-4 mx-auto bg-gray-900">
                </div>
            </div>
        </div>
    )
